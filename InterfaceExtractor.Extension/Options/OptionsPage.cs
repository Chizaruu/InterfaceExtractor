...
namespace InterfaceExtractor.Options
{
    ...
    public class GeneralOptionsPage : DialogPage
    {
        ...
        [Description("Show a warning dialog if the interface name doesn't start with 'I'.")]
        [DefaultValue(true)]
        ...
        [Description("Group interface members by type (Properties, Methods, Events, Indexers).")]
        [DefaultValue(false)]
